...
public class ClassData{
    ...
    public void addBasicClasses(){
       ...
       //Inserting Object class and its methods to  methodlist of the class Structure 
		classes_list.put("Object", new ClassStructure("Object", null, new HashMap<String, AST.attr>(), new HashMap <String, AST.method>()));
		...
		classes_list.put("IO", new ClassStructure("IO", "Object", new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
		...
		classes_list.put("Int", new ClassStructure("Int", "Object", new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
        // inherited methods of Object class
		...
		classes_list.put("Bool", new ClassStructure("Bool", "Object", new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
        // inherited methods of Object class
		...
		classes_list.put("String", new ClassStructure("String", "Object", new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
    ...
    public void addClassDetails(AST.class_ cl){
        ...
        ClassStructure clsStructure = new ClassStructure(cl.name, cl.parent, classes_list.get(cl.parent).attrlist, classes_list.get(cl.parent).methodlist);
        ...
        for(AST.feature ft : cl.features) {
            if(ft.getClass() == AST.attr.class) {
                ...
                if(classMethods.containsKey(mthdTemp.name)) {
                    ...
                    // else adding tht method to the methodlist
